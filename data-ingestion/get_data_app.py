...
@app.route('/')
def welcome():
    return '<html><a href="ingest">get all data </a> dpd data</html>'
...
def ingest_all_data():
    try:
        ...
        status = '<html>Sorry, this capability is accessible only by the Cron service, \
        but I got a KeyError for {} -- try invoking it from\
         <a href="{}"> the GCP console /AppEngine / taskqueues </a></html>'\
         .format(e,
                 'http://console.cloud.google.com/appengine/taskqueues?\
                 tab=CRON')
